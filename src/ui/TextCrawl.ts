...
import { textCrawlStyles } from "../styles/TextCrawlStyles";
...
export class TextCrawl {
  ...
  constructor(game: Game) {
    ...
    // Apply styles
    StyleManager.applyStyles("textCrawl", textCrawlStyles);
  ...
  dispose(): void {
    // Remove styles
    StyleManager.removeStyles("textCrawl");
    ...
    this.logger.info("TextCrawl: Disposed");
  }
